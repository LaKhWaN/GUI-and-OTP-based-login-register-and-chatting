...
# OTP_AUTH if its False then OTP functionality would be disabled. (To be added)
OTP_AUTH = True

# Creating a connnection and cursor with the database and checking the connection.
try:
    mydb = sql.connect(host="freedb.tech",user="freedbtech_lakhwanpython",\
        passwd="Lakhwanpython96",database="freedbtech_lakhwanpython")
...
def HomeWindow():
    ...
    Button(frame,text="Chat Lobby",padx=34,pady=5,command=ChatWindowLoad,bg="#33ccff").grid(row=0,column=0,ipadx=10,ipady=10)
